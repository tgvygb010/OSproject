...
public class Hangman extends JLabel {
    ...
    private static final long serialVersionUID = -987279675776827528L;
     ...
     */
    public Hangman() {
        this("hangman", "resources/images/", ".png");
    }

    /**
     * Creates a new Hangman given the image series' base name, the directory of the
     * hangman images, and the type of image.
     * 
