...
public class GameBoard extends JFrame {
    ...
    /**
     * Display the password hidden as *'s, revealing each letter as it is guessed
     */
    ...
    public GameBoard() {
        ...
        // The default directory for the sample images is resources/images/ and the
        // default image type is .png; ensure this directory is
        // created in the project folder if the sample images are used.
        HANGMAN_IMAGE_DIRECTORY = LETTER_IMAGE_DIRECTORY = RESOURCES_IMAGES;
    ...
    /**
     * Initializes all elements of the GameBoard that must be refreshed upon the
     * start of a new game.
     */
    ...
    private void addCloseWindowListener() {
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent we) {
                int prompt = JOptionPane.showConfirmDialog(null, "Are you sure you want to quit?", "Quit?",
    ...
    /**
     * Adds the LetterRack to the bottom of the GameBoard and attaches the
     * LetterTile TileListeners to the LetterTiles.
     */
