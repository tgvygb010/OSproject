...
public class LetterTile extends JLabel {
    ...
    private static final long serialVersionUID = 2691930530029426472L;
    ...
    /**
     * A custom MouseListener from the GameBoard class to change the tiles on a
     * click.
     */
     ...
     */
    public LetterTile() {
        this('a', "resources/images/", ".png");
    }

    /**
     * Creates a new LetterTile given the letter to be displayed, the directory of
     * the letter image series, and the image type.
     * 
    ...
    private BufferedImage loadImage(String imagePath) {
        ...
        try {
            ...
            img = ImageIO.read(classLoader.getResourceAsStream(imagePath));
        }
    ...
    /**
     * Changes the tile's appearance and removes the mouse listener to prevent the
     * tile from being clicked again.
     * 
